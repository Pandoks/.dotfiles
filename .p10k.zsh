# Generated by Powerlevel10k configuration wizard on 2026-07-27 at 19:53 UTC.
...
() {
  ...
  typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_FOREGROUND="${P10K_SSH_FOREGROUND:-180}"
  ...
  typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_TEMPLATE='󰣀 %n@%m'
